...
Currently there is an OpenGL back-end for NanoVG: [nanovg_gl.h](/src/nanovg_gl3.h) for OpenGL 2.0, OpenGL ES 2.0, OpenGL 3.2 core profile and OpenGL ES 3. The implementation can be chosen using a define as in above example. See the header file and examples for further info.
