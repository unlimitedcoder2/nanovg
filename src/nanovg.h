...
enum NVGLogLevel {
	NVG_LOG_LEVEL_INFO,
	NVG_LOG_LEVEL_WARNING,
	NVG_LOG_LEVEL_ERROR
};

typedef enum NVGLogLevel NVGLogLevel;

typedef void (*logFn_t)(void *userPtr, NVGLogLevel logLevel, const char *msg);

struct NVGUserImplementation
{
	void *userPtr;
	logFn_t log;
};

typedef struct NVGUserImplementation NVGUserImplementation;
